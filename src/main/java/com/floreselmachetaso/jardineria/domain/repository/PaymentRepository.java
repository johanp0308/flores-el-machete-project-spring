...
public interface PaymentRepository extends JpaRepository<Payment, String> {
     ...
     */
    @Query("SELECT codigo_pedido, COUNT(DISTINCT codigo_producto) AS num_productos_diferentes " + //
                "FROM detalle_pedido " + //
     ...
     */
    @Query("SELECT codigo_pedido, SUM(cantidad) AS cantidad_total_productos " + //
                "FROM detalle_pedido " + //
                "GROUP BY codigo_pedido")
    ...
    @Query("SELECT  " + //
                ...
                "LIMIT ?")
    List<Object[]> topProductsMoreSales(int top);
